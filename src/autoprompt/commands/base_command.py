...
class BaseCommand(ABC, CommandProtocol):
    ...
    def execute(self) -> CommandResult:
        ...
        try:
            self._settings = Settings.load(common_paths.settingsfile_path())
        ...
        self.logger.report_message(f"Command {self.name()} ran in {duration_from_perfcounters(start_counter, end_counter)} seconds.")
